...
namespace UnitsNet
{
    ...
    public partial struct ReciprocalLength : IQuantity<ReciprocalLengthUnit>, IEquatable<ReciprocalLength>, IComparable, IComparable<ReciprocalLength>, IConvertible, IFormattable
    {
        ...
        /// <remarks>Consider using <see cref="Equals(ReciprocalLength, double, ComparisonType)"/> for comparing floating point values with rounding error tolerances.</remarks>
        public static bool operator ==(ReciprocalLength left, ReciprocalLength right)
        {
        ...
        public ReciprocalLength ToUnit(ReciprocalLengthUnit unit, UnitConverter unitConverter)
        {
            ...
            else if (unitConverter.TryGetConversionFunction((typeof(ReciprocalLength), Unit, typeof(ReciprocalLength), unit), out var conversionFunction))
            {
                ...
                return (ReciprocalLength)converted;
            }
