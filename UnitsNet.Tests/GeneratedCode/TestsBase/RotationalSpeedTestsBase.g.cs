...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void RotationalSpeed_QuantityInfo_ReturnsQuantityInfoDescribingQuantity()
        {
            ...
            var units = EnumUtils.GetEnumValues<RotationalSpeedUnit>().ToArray();
        ...
        public void ToUnit_FromNonBaseUnit_ReturnsQuantityWithGivenUnit(RotationalSpeedUnit unit)
        {
            ...
            var fromUnit = RotationalSpeed.Units.Where(u => u != RotationalSpeed.BaseUnit).DefaultIfEmpty(RotationalSpeed.BaseUnit).First();
